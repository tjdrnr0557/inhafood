...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_3___default.a {
  ...
  render() {
    ...
    return __jsx("html", htmlAttrs, __jsx("head", null, this.props.styleTags, Object.values(helmet).map(el => el.toComponent())), __jsx("body", bodyAttrs, __jsx(next_document__WEBPACK_IMPORTED_MODULE_3__["Main"], null), __jsx(next_document__WEBPACK_IMPORTED_MODULE_3__["NextScript"], null)));
  }
